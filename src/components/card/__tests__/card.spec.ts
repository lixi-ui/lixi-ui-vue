...
describe('Card.vue', () => {
  ...
  test('body style', () => {
    ...
    expect(wrapper.find('.lx-card__body').attributes('style')).toBe(style)
  })
  ...
  test('body style with object', () => {
    ...
    expect(wrapper.find('.lx-card__body').attributes('style')).toBe('font-size: 14px;')
  })
  ...
  test('body style with array', () => {
    ...
    expect(wrapper.find('.lx-card__body').attributes('style').replace(/[ ]/g, '')).toBe('font-size:14px;color:blue;')
  })
