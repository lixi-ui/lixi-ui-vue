...
describe('Datetime Picker', () => {
  ...
  it('both picker show correct formated value (extract date-format and time-format from format property', async () => {
    ...
    input.trigger('focus')
    await nextTick()
    const dateInput = document.querySelector('.lx-date-picker__time-header > span:nth-child(1) input')
    const timeInput = document.querySelector('.lx-date-picker__time-header > span:nth-child(2) input');
  ...
  it('both picker show correct value', async () => {
    ...
    let spinners = document.querySelectorAll('.lx-time-spinner ul li.active') as any
    ...
    await nextTick()
    spinners = document.querySelectorAll('.lx-time-spinner ul li.active') as any
  ...
  it('click now button', async () => {
    ...
    input.trigger('focus')
    await nextTick();
    (document.querySelector('.lx-picker-panel__link-btn') as HTMLElement).click()
    await nextTick()
  ...
  it('timepicker select && input time && input date', async () => {
    ...
    input.trigger('focus')
    await nextTick()
    const input_ = document.querySelectorAll('.lx-date-picker__editor-wrap input')[1];
    (input_ as HTMLElement).focus()
    await nextTick()
    const timePanel = document.querySelector('.lx-time-panel')
    expect(timePanel.querySelector('.lx-time-spinner').innerHTML).not.toBeNull()
    const button = document.querySelector('.lx-time-panel .confirm') as HTMLElement
    button.click()
    await nextTick()
    expect(vm.value).not.toBe('')
    const timeInput = document.querySelectorAll('.lx-date-picker__editor-wrap input')[1] as HTMLInputElement
    ...
    const dateInput = document.querySelector('.lx-date-picker__editor-wrap input') as HTMLInputElement
  ...
  it('now button: can not choose disabled date', async () => {
    ...
    await nextTick()
    // click now button
    const btn = document.querySelector('.lx-picker-panel__footer .lx-button--text') as HTMLElement
    btn.click()
    await nextTick()
    const vm = wrapper.vm as any
    expect(vm.value).toBe('')
  ...
  it('confirm button honors picked date', async () => {
    ...
    (document.querySelector('.lx-date-picker__header .lx-icon-arrow-right') as HTMLElement).click();
    (document.querySelector('.lx-date-picker__header .lx-icon-d-arrow-right') as HTMLElement).click();
    // click confirm button
    (document.querySelector('.lx-picker-panel__footer .lx-button--default') as HTMLElement).click()
    const vm = wrapper.vm as any
  ...
  it('selectableRange', async () => {
    ...
    input.trigger('focus')
    await nextTick()
    const input1 = document.querySelectorAll('.lx-date-picker__editor-wrap input')[1] as HTMLInputElement
    input1.blur()
    input1.focus()
    await nextTick()
    const list = document.querySelectorAll('.lx-time-spinner__list')
  ...
  it('defaultTime takes effect when the type is datetime', async () => {
    ...
    input.trigger('focus')
    await nextTick()
    const someDateTd = document.querySelector('.lx-picker-panel__content tr:nth-child(3) td:nth-child(4)')
    const timeInput = document.querySelector('.lx-date-picker__time-header > span:nth-child(2) input');
    ...
    // time spinner highlight is correct
    const spinners = document.querySelectorAll('.lx-time-spinner ul li.active') as any
...
describe('Datetimerange', () => {
  ...
  it('select daterange and default Time and input format', async () => {
    ...
    input.trigger('focus')
    await nextTick()
    const pickers = document.querySelectorAll('.lx-date-range-picker__content')
    ...
    const pickerss = document.querySelectorAll('.lx-date-range-picker__time-header .lx-date-range-picker__editors-wrap')
    const left = {
      dateInput: pickerss[0].querySelector('.lx-date-range-picker__time-picker-wrap:nth-child(1) input'),
      timeInput: pickerss[0].querySelector('.lx-date-range-picker__time-picker-wrap:nth-child(2) input'),
    }
    const right = {
      dateInput: pickerss[1].querySelector('.lx-date-range-picker__time-picker-wrap:nth-child(1) input'),
      timeInput: pickerss[1].querySelector('.lx-date-range-picker__time-picker-wrap:nth-child(2) input'),
    }
    await nextTick()
    // both input shows correct value
  ...
  it('input date', async () => {
    ...
    await nextTick()
    const pickerss = document.querySelectorAll('.lx-date-range-picker__time-header .lx-date-range-picker__editors-wrap')
    const leftDateInput = pickerss[0].querySelector('.lx-date-range-picker__time-picker-wrap:nth-child(1) input') as HTMLInputElement
    const rightDateInput = pickerss[0].querySelector('.lx-date-range-picker__time-picker-wrap:nth-child(1) input') as HTMLInputElement
    ...
    triggerEvent(rightCell, 'click', true)
    await nextTick()
    const btn = document.querySelector('.lx-picker-panel__footer .lx-button--default') as HTMLElement
    btn.click()
    await nextTick()
    const vm = wrapper.vm as any
    expect(vm.value.map(_ => dayjs(_).format(formatStr)))
  ...
  it('select time', async () => {
    ...
    input.trigger('focus')
    await nextTick()
    const timeInput = document.querySelectorAll('.lx-date-range-picker__editors-wrap input')[1] as HTMLInputElement
    timeInput.blur()
    timeInput.focus()
    timeInput.blur()
    await nextTick()
    const button = document.querySelector('.lx-date-range-picker__time-picker-wrap .lx-time-panel .confirm') as HTMLElement
    button.click()
    await nextTick()
    const btn = document.querySelector('.lx-picker-panel__footer .lx-button--default') as HTMLElement
    btn.click()
  ...
  it('confirm honors disabledDate', async () => {
    ...
    btn.click()
    await nextTick()
    const rangePanel = document.querySelector('.lx-date-range-picker')
  ...
  it('selectableRange', async () => {
    ...
    await nextTick()
    const pickerss = document.querySelectorAll('.lx-date-range-picker__time-header .lx-date-range-picker__editors-wrap')
    const leftDateInput = pickerss[0].querySelector('.lx-date-range-picker__time-picker-wrap:nth-child(2) input') as HTMLInputElement
    const rightDateInput = pickerss[1].querySelector('.lx-date-range-picker__time-picker-wrap:nth-child(2) input') as HTMLInputElement
    leftDateInput.blur()
    leftDateInput.focus()
    await nextTick()
    const listleft = document.querySelectorAll('.lx-date-range-picker__editors-wrap .lx-time-spinner__list')
    ...
    await nextTick()
    const listright = document.querySelectorAll('.lx-date-range-picker__editors-wrap.is-right .lx-time-spinner__list')
  ...
  it('select same date, different time', async () => {
    ...
    triggerEvent(leftCell, 'click', true)
    await nextTick()
    const leftTimeInput = document.querySelectorAll('.lx-date-range-picker__editors-wrap input')[1] as HTMLInputElement
    leftTimeInput.blur()
    leftTimeInput.focus()
    await nextTick()
    const leftList = document.querySelectorAll('.lx-time-spinner__list')
    ...
    await nextTick();
    (document.querySelector('.lx-time-panel__btn.confirm') as HTMLElement).click()
    await nextTick()
    const rightTimeInput = document.querySelectorAll('.lx-date-range-picker__editors-wrap input')[3] as HTMLInputElement
    rightTimeInput.blur()
    rightTimeInput.focus()
    await nextTick()
    const rightList = document.querySelectorAll('.is-right .lx-time-spinner__list')
    // auto set left time to right time
    expect(rightList[0].querySelector('.lx-time-spinner__item.active').innerHTML).toBe(leftSelect[0])
    expect(rightList[1].querySelector('.lx-time-spinner__item.active').innerHTML).toBe(leftSelect[1])
    expect(rightList[2].querySelector('.lx-time-spinner__item.active').innerHTML).toBe(leftSelect[2])
    ...
    await nextTick();
    (document.querySelector('.is-right .lx-time-panel__btn.confirm') as HTMLElement).click()
    await nextTick();
    (document.querySelector('.lx-picker-panel__footer .lx-button--default') as HTMLElement).click()
    await nextTick()
    const vm = wrapper.vm as any
