...
describe('Dialog.vue', () => {
  test('render test', async () => {
    ...
    await rAF()
    await nextTick()
    expect(wrapper.find('.lx-dialog__body').text()).toEqual(AXIOM)
  })
  ...
  test('dialog should have a title when title has been given', async () => {
    ...
    await nextTick()
    expect(wrapper.find('.lx-dialog__header').text()).toBe(HEADER)
  ...
  test('dialog should have a footer when footer has been given', async () => {
    ...
    await nextTick()
    expect(wrapper.find('.lx-dialog__footer').exists()).toBe(true)
    expect(wrapper.find('.lx-dialog__footer').text()).toBe(AXIOM)
  })
  ...
  test('should center dialog', async () => {
    ...
    await nextTick()
    expect(wrapper.find('.lx-dialog--center').exists()).toBe(true)
  })
  ...
  test('should show close button', async () => {
    ...
    await nextTick()
    expect(wrapper.find('.lx-dialog__close').exists()).toBe(true)
  })
  ...
  test('should hide close button when showClose = false', async () => {
    ...
    await nextTick()
    expect(wrapper.find('.lx-dialog__headerbtn').exists()).toBe(false)
  })
  ...
  test('should close dialog when click on close button', async () => {
    ...
    await nextTick()
    await wrapper.find('.lx-dialog__headerbtn').trigger('click')
  ...
  describe('mask related', () => {
    test('should not have overlay mask when mask is false', async () => {
      ...
      await nextTick()
      expect(wrapper.find('.lx-overlay').exists()).toBe(false)
    })
    ...
    test('should close the modal when clicking on mask when `closeOnClickModal` is true', async () => {
      ...
      await nextTick()
      expect(wrapper.find('.lx-overlay').exists()).toBe(true)

      await triggerCompositeClick(wrapper.find('.lx-overlay'))
      expect(wrapper.vm.visible).toBe(false)
    })
  })
  ...
  describe('life cycles', () => {
    ...
    test('should destroy on close', async () => {
      ...
      await rAF()
      await nextTick()
      expect(wrapper.find('.lx-dialog__body').exists()).toBe(false)
    })
