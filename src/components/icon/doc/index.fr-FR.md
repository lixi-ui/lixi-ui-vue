...
- If you want to see all available SVG icons please check [@lixi/icons](https://unpkg.com/browse/@lixi/icons@latest/lib/) and the source [Github/ElementPlus/icons](https://github.com/lixi-ui-vue/lixi-ui-vue-icons) out or [SVG icons](/#/fr/component/icon#svg-tu-biao-ji-he)
