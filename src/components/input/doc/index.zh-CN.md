...
:::demo
```html
<lx-input v-model="input" placeholder="请输入内容"></lx-input>
...
```html
<lx-input placeholder="请输入密码" v-model="input" show-password></lx-input>
...
```html
<div>
  <lx-input placeholder="请输入内容" v-model="input1">
    <template #prepend>Http://</template>
  </lx-input>
</div>
<div style="margin-top: 15px">
  <lx-input placeholder="请输入内容" v-model="input2">
...
<div style="margin-top: 15px">
  ...
  >
    <template #prepend>
      <lx-select v-model="select" placeholder="请选择">
        <lx-option label="餐厅名" value="1"></lx-option>
        <lx-option label="订单号" value="2"></lx-option>
        <lx-option label="用户电话" value="3"></lx-option>
      </lx-select>
    </template>
    <template #append>
