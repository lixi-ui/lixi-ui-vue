...
<div class="buttons">
  <lx-button @click="getCheckedNodes">通过 node 获取</lx-button>
  <lx-button @click="getCheckedKeys">通过 key 获取</lx-button>
  <lx-button @click="setCheckedNodes">通过 node 设置</lx-button>
  <lx-button @click="setCheckedKeys">通过 key 设置</lx-button>
  <lx-button @click="resetChecked">清空</lx-button>
</div>
