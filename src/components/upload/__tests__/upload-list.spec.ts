...
describe('<upload-list />', () => {
  ...
  describe('functionalities', () => {
    ...
    test('handle preview works', async () => {
      ...
      await wrapper.find('.lx-upload-list__item-name').trigger('click')
      ...
      await wrapper.find('.lx-upload-list__item-preview').trigger('click')
    ...
    test('handle delete works', async () => {
      ...
      await wrapper.find('.lx-icon-close').trigger('click')
      expect(remove).toHaveBeenCalled()

      await wrapper.find('.lx-upload-list__item').trigger('keydown', {
      ...
      await wrapper.find('.lx-upload-list__item-delete').trigger('click')
